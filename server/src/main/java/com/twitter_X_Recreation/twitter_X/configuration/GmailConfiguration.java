...
public class GmailConfiguration {
    ...
    private static final String APPLICATION_NAME= "x-twitter-recreation";
    ...
    private static final String CREDENTIALS_FILE_PATH = "/client_secret.apps.googleusercontent.com.json";
